    ...
    void Update()
    {
        if (block == null)
        {
            ...
            if (!lightProbeProxyVolume)
            {
                ...
                Vector4[] occlusionProbes = new Vector4[generateNumber];
                LightProbes.CalculateInterpolatedLightAndOcclusionProbes(lightProbePosition, lightProbes, occlusionProbes);
